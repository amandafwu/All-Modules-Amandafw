...
# Type I and Type II Errors and Statistic Power
...
# Run this function with this code with the data values:
eI <- typeI(mu0 = -3, sigma = 2, n = 5000, alternative = "greater", alpha = 0.05) # k will equal 1000 because it is not specified
#or 
...
eI <- typeI(mu0 = -3, sigma = 2, n = 5000, alternative = "greater", alpha = 0.05, k = 10000)
#or
eI <- typeI(mu0 = -3, sigma = 2, n = 5000, alternative = "greater", alpha = 0.05, k = 2000)
#or 
eI <- typeI(mu0 = -3, sigma = 2, n = 200, alternative = "greater", alpha = 0.05)
#or
eI <- typeI(mu0 = -3, sigma = 2, n = 10000, alternative = "greater", alpha = 0.05)
```
...
#protects data from type 1 errors
...
p <- ggplot(data = d, aes(x = rank, y = pvals)) + geom_point() + geom_line(aes(x = rank,
    y = psig)) #anything below the line should be considered significant
p
